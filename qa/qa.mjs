...
try {
  ...
  // timeline
  await page.goto(`${BASE}/#timeline/alcibiades`);
  await page.waitForTimeout(1200);
  ...
  // light theme
  await page.goto(`${BASE}/#graph/thucydides`);
  ...
  await mob.goto(BASE + "/#graph/lysander");
  await mob.waitForTimeout(1500);
  await mob.screenshot({ path: OUT + "14-mobile-panel.png" });
  await mob.goto(BASE + "/#timeline");
